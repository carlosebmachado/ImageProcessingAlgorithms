...
namespace IPA.Core
{
	public class M3Algorithms
	{
        ...
        public static string BackgroundSubtraction(string path)
        {
            ...
            var videoWriter = new VideoWriter(newPath, VideoWriter.Fourcc('M', 'P', '4', 'V'), 30, new Size(w, h), true);
            ...
            foreach (var frame in frames)
            {
                ...
                for (int y = 0; y < bg.Height; y++)
                {
                    for (int x = 0; x < bg.Width; x++)
                    {
                        ...
                        bgR = (byte)(bgPixel.R * 0.99 + btmPixel.R * 0.01);
                        bgG = (byte)(bgPixel.G * 0.99 + btmPixel.G * 0.01);
                        bgB = (byte)(bgPixel.B * 0.99 + btmPixel.B * 0.01);
